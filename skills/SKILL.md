...
The generated output is **not the final QA suite**.

Its purpose is to provide a lightweight baseline that will later be expanded by `test-case-reviewer` into a comprehensive set of test cases covering:
